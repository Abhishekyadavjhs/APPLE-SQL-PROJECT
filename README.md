...
## Datasets
The datasets used in this project are large, so they are hosted on Google Drive.  
[Click here to access the datasets](https://drive.google.com/drive/folders/1GEhrTl84Tio63xtVxfaScHml0lVgyTEA?usp=sharing)



## Project Overview

This project focuses on analyzing over 1 million rows of Apple retail sales data using advanced SQL queries.
The dataset includes information about Apple products, categories, stores, sales transactions, and warranty claims.
The objective of the project is to extract meaningful business insights by applying SQL concepts ranging from basic aggregations to complex window functions. The project simulates real-world scenarios faced by data analysts working with large-scale retail datasets.
...
- **Comprehensive Coverage**: Each table provides new opportunities to explore SQL concepts. And this also help in understand the real world problem.
